...
{
    public Collected(Generator<Collection> collectionGenerator, Iterable<Value> values)
    {
        super(new Reduced<Value, Collection>(collectionGenerator, (collection, value) -> {
