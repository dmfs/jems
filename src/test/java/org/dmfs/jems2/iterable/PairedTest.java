...
public class PairedTest
{
    ...
    {
        assertThat(
            new Paired<>(EmptyIterable.emptyIterable(), EmptyIterable.emptyIterable()),
            is(emptyIterable()));

        assertThat(
            new Paired<>(new Seq<>(1, 2, 3), EmptyIterable.emptyIterable()),
            is(emptyIterable()));

        assertThat(
            new Paired<>(EmptyIterable.emptyIterable(), new Seq<>(1, 2, 3)),
            is(emptyIterable()));
